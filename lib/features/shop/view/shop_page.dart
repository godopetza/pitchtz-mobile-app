                    ...
                    child: Row(
                      children: [
                        _OperatorChip(
                          ...
                          selected: vm.selectedOperator == 'MPESA_TZA',
                          onTap: () => vm.setOperator('MPESA_TZA'),
                        ),
                        const SizedBox(width: 8),
                        _OperatorChip(
                          label: 'Airtel',
                          color: AppColors.airtel,
                          selected: vm.selectedOperator == 'AIRTELMONEY_TZA',
                          onTap: () => vm.setOperator('AIRTELMONEY_TZA'),
                        ),
                        const SizedBox(width: 8),
                        _OperatorChip(
                          label: 'HaloPesa',
                          color: AppColors.halo,
                          selected: vm.selectedOperator == 'HALOPESA_TZA',
                          onTap: () => vm.setOperator('HALOPESA_TZA'),
                        ),
                        const SizedBox(width: 8),
                        _OperatorChip(
                          label: 'TigoPesa',
                          color: AppColors.mixx,
                          selected: vm.selectedOperator == 'TIGOPESA_TZA',
                          onTap: () => vm.setOperator('TIGOPESA_TZA'),
                        ),
                      ],
                    ),
                  ),
